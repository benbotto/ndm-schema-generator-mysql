...
require('insulin').factory('ndm_MySQLSchemaGenerator', ndm_MySQLSchemaGeneratorProducer);

function ndm_MySQLSchemaGeneratorProducer() {
   ...
   */
  class MySQLSchemaGenerator extends EventEmitter {
    /**
     * Initialize the schema generator.
     * @param {MySQLDataContext} infoSchemaDC - A MySQLDataContext instance for
